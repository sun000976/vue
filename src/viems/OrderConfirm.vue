      ...
      <div class="checkout-order">
              ...
              <li v-for="item in cartList" v-if="item.checked=='1'">
                <div class="cart-tab-1">
                  <div class="cart-item-pic">
                    <img :src="'/static/'+item.productImage" alt="item.productNmae">
                  </div>
        ...
        <div class="order-foot-wrap">
          <div class="prev-btn-wrap">
            <router-link class="btn btn--m btn--red" to="/address">返回上一级</router-link>
          </div>
...
<style>
	.cart-item .cart-item-list .cart-tab-1{
		padding-left: 200px;
	}
</style>
<script>
  ...
  export default{
      ...
      methods:{
        init(){
        	axios.get('/goods/cartList').then((response)=>{
        		...
        		this.orderTotal = this.tax+this.subTotal+this.shipping-this.discount;
        	})
        },
        payMent(){
        	var addressId = this.$route.query.addressId;
        	axios.post('goods/payMent',{
        		addressId:addressId,
